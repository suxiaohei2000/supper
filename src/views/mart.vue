    ...
    <div class="mart-content">
            ...
            <ul class="item-content-box">
              <li v-for="item in moneyTypeList" @click="selectMoneyType(item)">
                <div class=" li-box-left">
                  <i class="icon-money" :class="item.image"></i>
                </div>
      ...
      <div class="mart-step-2-content" v-if="step==2">
        ...
        <div class="mart-step-box">
          <div class="change-content">
            <div class="input-box">
              <i class="fa" :class="moneyType.icon"></i>
          ...
          <div class="package-content">
            ...
            <div class="package-box">
              ...
              <span :style="codeStyle" @click="refreshImage"></span>
      ...
      <div class="mart-step-3-content" v-if="step==3">
        <div class="mart-step-title">
          ...
          <p>
            0x25708d7554d55241a32bba9f422edd48bffe4bae
          </p>
          <p>
        ...
        <ul class="order-content">
          ...
          <li>
            <span>下单时间：</span>
            <span>{{martData.createTime | timeFilter}}</span>
          </li>
          <li>
            <span>兑换数量：</span>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      codeStyle: function () {
        return {
          backgroundImage: "url(/platform/web/base/code?time=" + this.time + ")"
        };
      }
    },
    created() {
...
//      获取数据
      ...
      next: function (item) {
        ...
        var wms_user_identity=$$.getCookie('wms_user_identity');
        if(!wms_user_identity){
          this.$router.push({
            name:'login',
            query:{
              redirect:encodeURIComponent('/mart')
            }
          })
          return;
        }
